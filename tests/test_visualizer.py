...
def simulate_training():
    ...
    server_thread = start_visualization_server(host="127.0.0.1", port=8080, open_browser=True)
    ...
    try:
        while True:
            ...
            # Update visualizer
            viz.update_training_step(loss=loss, learning_rate=lr, batch=batch, outputs=outputs, optimizer=optimizer)
            ...
            if step % 50 == 0:
                ...
                val_metrics = {"accuracy": random.uniform(0.8, 0.95), "wer": random.uniform(0.05, 0.15)}

...
from gemma_tuner.models.gemma.finetune import _config_is_multimodal_gemma_like
...
def test_config_multimodal_from_architecture_conditional():
    ...
    assert _config_is_multimodal_gemma_like(cfg) is True
...
def test_config_text_only_causal():
    ...
    assert _config_is_multimodal_gemma_like(cfg) is False

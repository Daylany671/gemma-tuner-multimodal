...
- Train (profile)
  ...
  - New: `gemma-macos-tuner finetune <profile> --config config.ini`

- Evaluate (profile or model+dataset)
  - Legacy: `python main.py evaluate <profile|model+dataset> --config config.ini`
  - New: `gemma-macos-tuner evaluate <profile|model+dataset> --config config.ini`

- Blacklist generation
  - Legacy: `python main.py blacklist <profile> --config config.ini`
  - New: `gemma-macos-tuner blacklist <profile> --config config.ini`

...
python -m gemma_tuner.scripts.pseudo_label \
...
gemma-macos-tuner finetune distil-whisper-profile \
...
python -m gemma_tuner.scripts.pseudo_label --model_name_or_path whisper-base

# Round 2: Fine-tune on pseudo-labels
gemma-macos-tuner finetune whisper-pseudo-round1

# Round 3: Re-label with improved model
python -m gemma_tuner.scripts.pseudo_label --model_name_or_path output/whisper-pseudo-round1
